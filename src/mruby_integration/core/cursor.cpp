...
mrb_value mrb_is_cursor_on_screen(mrb_state*, mrb_value) {
...
void append_core_cursor(mrb_state *mrb) {
  ...
  mrb_define_method(mrb, mrb->kernel_module, "is_cursor_on_screen?", mrb_is_cursor_on_screen, MRB_ARGS_NONE());
}
