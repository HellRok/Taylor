...
mrb_value mrb_cursor_hidden(mrb_state*, mrb_value) {
...
mrb_value mrb_cursor_on_screen(mrb_state*, mrb_value) {
...
void append_core_cursor(mrb_state *mrb) {
  ...
  mrb_define_method(mrb, mrb->kernel_module, "cursor_hidden?", mrb_cursor_hidden, MRB_ARGS_NONE());
  ...
  mrb_define_method(mrb, mrb->kernel_module, "cursor_on_screen?", mrb_cursor_on_screen, MRB_ARGS_NONE());
}
