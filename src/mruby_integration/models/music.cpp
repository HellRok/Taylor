...
void setup_Music(mrb_state* mrb,
                 mrb_value object,
                 Music* music,
                 int context_type,
                 bool looping,
...
auto mrb_Music_initialize(mrb_state* mrb, mrb_value self) -> mrb_value
{
  char* path;
...
auto mrb_Music_unload(mrb_state* mrb, mrb_value self) -> mrb_value
{
...
auto mrb_Music_valid(mrb_state* mrb, mrb_value self) -> mrb_value
{
  mrb_get_self(mrb, self, Music, music);
...
auto mrb_Music_get_looping(mrb_state* mrb, mrb_value self) -> mrb_value
{
  mrb_get_self(mrb, self, Music, music);
...
auto mrb_Music_set_looping(mrb_state* mrb, mrb_value self) -> mrb_value
{
  attr_setter_bool(mrb, self, Music_type, Music, looping, looping);
}

auto mrb_Music_play(mrb_state* mrb, mrb_value self) -> mrb_value
{
  mrb_get_self(mrb, self, Music, music);

  if (!IsAudioDeviceReady()) {
    raise_error(
      mrb, Audio_class, "NotOpenError", "You must use Audio.open before calling Music#play.");
  }
...
auto mrb_Music_playing(mrb_state* mrb, mrb_value self) -> mrb_value
{
  mrb_get_self(mrb, self, Music, music);
...
auto mrb_Music_stop(mrb_state* mrb, mrb_value self) -> mrb_value
{
  mrb_get_self(mrb, self, Music, music);
...
auto mrb_Music_played(mrb_state* mrb, mrb_value self) -> mrb_value
{
  mrb_get_self(mrb, self, Music, music);
...
auto mrb_Music_update(mrb_state* mrb, mrb_value self) -> mrb_value
{
  mrb_get_self(mrb, self, Music, music);
...
auto mrb_Music_pause(mrb_state* mrb, mrb_value self) -> mrb_value
{
  mrb_get_self(mrb, self, Music, music);
...
auto mrb_Music_resume(mrb_state* mrb, mrb_value self) -> mrb_value
{
  mrb_get_self(mrb, self, Music, music);
...
auto mrb_Music_length(mrb_state* mrb, mrb_value self) -> mrb_value
{
  mrb_get_self(mrb, self, Music, music);
...
auto mrb_Music_set_volume(mrb_state* mrb, mrb_value self) -> mrb_value
{
  mrb_get_self(mrb, self, Music, music);
...
auto mrb_Music_set_pitch(mrb_state* mrb, mrb_value self) -> mrb_value
{
  mrb_get_self(mrb, self, Music, music);
...
void append_models_Music(mrb_state* mrb)
{
  ...
  mrb_define_method(mrb, Music_class, "playing?", mrb_Music_playing, MRB_ARGS_NONE());
  mrb_define_method(mrb, Music_class, "stop", mrb_Music_stop, MRB_ARGS_NONE());
  mrb_define_method(mrb, Music_class, "played", mrb_Music_played, MRB_ARGS_NONE());
  mrb_define_method(mrb, Music_class, "update", mrb_Music_update, MRB_ARGS_NONE());
  ...
  mrb_define_method(mrb, Music_class, "length", mrb_Music_length, MRB_ARGS_NONE());
