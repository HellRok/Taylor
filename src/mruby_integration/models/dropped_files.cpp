...
auto
mrb_DroppedFiles_any(mrb_state*, mrb_value) -> mrb_value
{
  return mrb_bool_value(IsFileDropped());
}

auto
mrb_DroppedFiles_all(mrb_state* mrb, mrb_value) -> mrb_value
{
...
void
append_models_DroppedFiles(mrb_state* mrb)
{
  ...
  mrb_define_class_method(
    mrb, DroppedFiles_class, "any?", mrb_DroppedFiles_any, MRB_ARGS_NONE());
  mrb_define_class_method(
    mrb, DroppedFiles_class, "all", mrb_DroppedFiles_all, MRB_ARGS_NONE());
}
